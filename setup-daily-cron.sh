...
# This script sets up a cron job to run the daily news generator every day at 4:20 PM CDT
...
# Create the cron job entry (runs every day at 4:20 PM CDT)
CRON_ENTRY="20 16 * * * cd $SCRIPT_DIR && $NODE_PATH $DAILY_SCRIPT >> $SCRIPT_DIR/daily-news.log 2>&1"

echo ""
echo "📅 Cron job will run: Every day at 4:20 PM CDT"
