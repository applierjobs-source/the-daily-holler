...
// This script can be run manually to start generation immediately
// It's the same as railway-generation.js but with immediate execution
...
async function runGenerationNow() {
  console.log('🚀 Starting immediate article generation on Railway...');
...
runGenerationNow().catch(console.error);
